...
async function generatePDF(campaignId) {
  ...
  textColor(doc, C.white);
  doc.fontSize(10).font('Helvetica').text('CAMP ADS AGENT', 40, 60, { characterSpacing: 3 });
  ...
  fillRect(doc, 40, 150, 240, 50, '#3730a3');
  textColor(doc, C.white);
  ...
  doc.fontSize(9).font('Helvetica')
    .text(`Generated by Camp Ads Agent on ${new Date().toLocaleString('vi-VN')}`, 40, doc.y, { align: 'center', width: 515 });
