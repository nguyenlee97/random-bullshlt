...
export default function CampaignHome({
  ...
  return (
    <main className="h-full overflow-x-hidden overflow-y-auto overscroll-contain bg-[radial-gradient(circle_at_15%_0%,rgba(255,255,255,.95),rgba(255,255,255,0)_34%),linear-gradient(180deg,#edf5ff_0,#eef2f8_620px)] text-slate-900">
