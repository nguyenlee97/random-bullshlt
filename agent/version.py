...
BUILD_VERSION = "2026-08-05.5"

BUILD_FEATURES = [
    "version-neutral-agent-ready-copy",
    ...
    "langfuse-vietnamese-display-normalization",
    "langfuse-session-explorer",
    "langfuse-scrollable-rich-metadata",
