...
async def handle_boot() -> AgentResponse:
    return AgentResponse(
        text=(
            ...
            "🔒 Nội dung chat, brief và creative được xử lý bởi dịch vụ AI để xây dựng campaign. Không nhập dữ liệu cá nhân hoặc bí mật không cần thiết. Bạn có thể xóa dữ liệu phiên bằng **Chiến dịch mới**.\n\n"
